class EvaluationController < ApplicationController
  ...
  def index
    begin
      ...
      BanditJobs::RewardsUpdateJob.perform_later(newsletter.user.segment_id, sections.first.id, value, frequency, (newsletter.created_at + 1.day).to_s) if sections.size == 1 && ![2297658, 880823].include?(newsletter.user.id)
